...
Interlocking border piece with the floor and wall pieces <ul><li>[DXF Files](full_scale_model_mini/modules/border_4cell_left/dxf)</li><li>[SVG Files](full_scale_model_mini/modules/border_4cell_left/svg)</li></ul> <br /> _6 modules_ | <img src="full_scale_model_mini/imgs/rendered/border_4cell_left.jpg" width="400px" alt="" />       |
Interlocking border piece with the floor and wall pieces <ul><li>[DXF Files](full_scale_model_mini/modules/border_4cell_right/dxf)</li><li>[SVG Files](full_scale_model_mini/modules/border_4cell_right/svg)</li></ul> <br /> _6 modules_ | <img src="full_scale_model_mini/imgs/rendered/border_4cell_right.jpg" width="400px" alt="" />       |
Interlocking border piece with the floor and wall pieces <ul><li>[DXF Files](full_scale_model_mini/modules/border_2cell/dxf)</li><li>[SVG Files](full_scale_model_mini/modules/border_2cell/svg)</li></ul> <br /> _4 modules_ | <img src="full_scale_model_mini/imgs/rendered/border_2cell.jpg" width="400px" alt="" />       |
Modular wall that fits into the border pieces <ul><li>[DXF Files](full_scale_model_mini/modules/wall_4cell/dxf)</li><li>[SVG Files](full_scale_model_mini/modules/wall_4cell/svg)</li></ul> <br /> _12 modules_ | <img src="full_scale_model_mini/imgs/rendered/wall_4cell.jpg" width="400px" alt="" />         |
Modular wall that fits into the border pieces <ul><li>[DXF Files](full_scale_model_mini/modules/wall_2cell/dxf)</li><li>[SVG Files](full_scale_model_mini/modules/wall_2cell/svg)</li></ul> <br /> _4 modules_ | <img src="full_scale_model_mini/imgs/rendered/wall_2cell.jpg" width="400px" alt="" />         |
...
Modular wall cover that secures the wall pieces together <ul><li>[DXF Files](full_scale_model_mini/modules/wall_corner_covers_2cell/dxf)</li><li>[SVG Files](full_scale_model_mini/modules/wall_corner_covers_2cell/svg)</li></ul> <br /> _4 modules_ | <img src="full_scale_model_mini/imgs/rendered/wall_corner_covers_2cell.jpg" width="400px" alt="" />  |
Modular wall cover that secures the wall pieces together <ul><li>[DXF Files](full_scale_model_mini/modules/wall_middle_covers_4cell/dxf)</li><li>[SVG Files](full_scale_model_mini/modules/wall_middle_covers_4cell/svg)</li></ul> <br /> _6 modules_ | <img src="full_scale_model_mini/imgs/rendered/wall_middle_covers_4cell.jpg" width="400px" alt="" />  |
Modular wall cover that secures the wall pieces together <ul><li>[DXF Files](full_scale_model_mini/modules/wall_middle_covers_2cell/dxf)</li><li>[SVG Files](full_scale_model_mini/modules/wall_middle_covers_2cell/svg)</li></ul> <br /> _2 modules_ | <img src="full_scale_model_mini/imgs/rendered/wall_middle_covers_2cell.jpg" width="400px" alt="" />  |
