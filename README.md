...
Modular wall that fits into the border pieces <ul><li>[DXF Files](small_scale_model/modules/module_7cell/dxf)</li><li>[SVG Files](small_scale_model/modules/walls/svg)</li></ul>| <img src="small_scale_model/imgs/rendered/wall.jpg" width="400px" alt="" />         | <img src="small_scale_model/imgs/real/wall.jpg" width="400px" alt="" />
